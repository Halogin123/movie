...
abstract class AbstractRepository implements IBaseRepository
{
    ...
    public function findOneBy(array $criteria)
    {
        $queryBuilder = $this->model->where(function ($query) use ($criteria) {
            $this->applySearchCriteriaInQueryBuilder($query, $criteria);
        });
...
//            }
     ...
     * @inheritdoc
     */
    public function getAllBy(array $datas)
    {
        return $this->model->where($datas)->get();
    }
     ...
     * @reutun int
     */
    public function sumBy(array $conditions, string $column = 'id'): mixed
    {
