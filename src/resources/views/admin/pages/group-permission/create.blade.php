        ...
        <div class="row mb-3">
            <div class="col-12">
                <ol class="breadcrumb" aria-label="breadcrumbs">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('group-permission.create') }}"
                                                                       class="text-success">Tạo nhóm quyền</a>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="card" style="border-radius: 10px;">
                    <div class="card-body">
                        <div class="form-group col-12 col-md-3">
                            <div class="field">
                                <label>Tên nhóm quyền <span class="text-red">*</span></label>
                        ...
                        <div class="card-footer">
                            <button onclick="createGroupPermission(`{{ route('group-permission.store') }}`)" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('page-js')
    <script>
        function createGroupPermission(url) {
